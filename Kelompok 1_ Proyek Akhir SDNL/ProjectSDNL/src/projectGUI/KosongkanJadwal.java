 ...
 * @author Ribka Restu
 */
public class KosongkanJadwal extends javax.swing.JFrame {

    public static ArrayList<Jadwal> jadwalKosong = HapusJadwal.jadwalHapus;

    /**
     * Creates new form HalamanUtama
     */
    public KosongkanJadwal() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Kosongkan Jadwal Misa");
        String temp1 = "";
        for (int i = 0; i < jadwalKosong.size(); i++) {
            temp1 += (i + 1) + ". " + jadwalKosong.get(i);
        }
        if (temp1.equals("")) {
    ...
    private void initComponents() {
        ...
        jButtonKosongkanJadwalMisa = new javax.swing.JButton();
        ...
        jButtonKosongkanJadwalMisa.setText("YA");
        jButtonKosongkanJadwalMisa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonKosongkanJadwalMisaMouseClicked(evt);
            }
        });
        jButtonKosongkanJadwalMisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonKosongkanJadwalMisaActionPerformed(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Bodoni MT", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 0));
        jLabel1.setText("Apakah anda yakin ingin menghapus semua jadwal ?");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jButtonKosongkanJadwalMisa)
                .addGap(215, 215, 215))
        ...
        jLabelKosongkanJadwalMisa.setForeground(new java.awt.Color(220, 150, 0));
...
//        jLabelKosongkanJadwalMisa.setForeground(new Color(255, 255, 255));
    ...
    private void jButtonKosongkanJadwalMisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonKosongkanJadwalMisaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonKosongkanJadwalMisaActionPerformed

    private void jButtonKosongkanJadwalMisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonKosongkanJadwalMisaMouseClicked
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_jButtonKosongkanJadwalMisaMouseClicked
    public void kosongkanJadwal() {
        jadwalKosong.removeAll(jadwalKosong);
        JOptionPane.showMessageDialog(null, "Semua jadwal berhasil dihapus");
        jTextAreaJadwalMisa.setText("");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KosongkanJadwal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton jButtonKosongkanJadwalMisa;
