...
public class Tree<E> {
    ...
    public int countNodes(TreeNode<E> r) {
        if (r == null) {
            return 0;
        } else {
            int jumlah = 1;
    ...
    public String inorderHelper(TreeNode localRoot) {

        if (localRoot != null) {
            inorderHelper(localRoot.getLeftNode());
            tampunginorder += " "+localRoot.getData();
            inorderHelper(localRoot.getRightNode());
        }
        return tampunginorder;
    }
