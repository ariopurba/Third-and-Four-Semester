...
public class LihatData extends javax.swing.JFrame {
    ...
    public static ArrayList<Jadwal> jadwalTerupdate = BatalMisa.jadwalTerupdate;
     String temp = "";
    ...
    public LihatData() {
        ...
        this.setTitle("Lihat Data Umat");

        for (int i = 0; i < jadwalTerupdate.size(); i++) {
            temp += jadwalTerupdate.get(i).toString() + "\nNama\t\tAlamat\tKode\n";
            temp += "=============================================\n";
            temp += jadwalTerupdate.get(i).getUmat().inorderTraversal() + "\n";
        }
        if (jadwalTerupdate.isEmpty()) {
            jTextAreaDataUmat.setText("Belum ada data");
        } else {
            jTextAreaDataUmat.setText(temp);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextAreaDataUmat = new javax.swing.JTextArea();
        ...
        jTextAreaDataUmat.setColumns(20);
        jTextAreaDataUmat.setLineWrap(true);
        jTextAreaDataUmat.setRows(5);
        jTextAreaDataUmat.setWrapStyleWord(true);
        jTextAreaDataUmat.setBorder(javax.swing.BorderFactory.createTitledBorder("Data Umat"));
        jScrollPane2.setViewportView(jTextAreaDataUmat);
        ...
        jLabelLihatDataUmat.setForeground(new java.awt.Color(220, 150, 0));
...
//          jLabelLihatDataUmat.setForeground(new Color(255,255,255));
    ...
    private javax.swing.JTextArea jTextAreaDataUmat;
