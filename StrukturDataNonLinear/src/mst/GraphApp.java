...
public class GraphApp {
    ...
    public static void main(String[] args) {
        ...
        test.addEdge('H', 'J', 6);
        test.addEdge('I', 'J', 7);
//        ArrayList<edge> mst = test.getPrimEdges();
//        for (int i = 0; i < mst.size(); i++) {
//            System.out.println(mst.get(i).toString());
//            totBeban += mst.get(i).getWeight();
//        }
//        System.out.println("Minimum Spanning Tree dari Graph adalah = "+totBeban);
        test.showEdges(test.getPrimEdges('G'));
//        System.out.println("\n");
