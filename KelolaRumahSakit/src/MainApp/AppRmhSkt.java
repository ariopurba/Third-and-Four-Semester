                ...
                switch (pilihan) {
                    ...
                    case 3:
                        ...
                        if (pohon.getCurrent(cariPasien) != null) {
                            System.out.println("Pasien Ditemukan di kamar"+pohon.getCurrent(cariPasien.getNo_kamar()));
                    ...
                    case 4:
                        ...
                        if (pohon.delete(hapuspasien)) {
                            int tampung = JOptionPane.showConfirmDialog(null, "Apakah Anda Ingin Menghapus Pasien Ini" +" ? ", "Konfirmasi", JOptionPane.YES_NO_OPTION);
