...
public class Pengembalian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No. ID Koleksi");

        jLabel2.setText("No. ID Peminjam");

        jTextField1.setText("Isi ID Koleksi");

        jTextField2.setText("Isi ID Peminjam");

        jButton1.setText("Dikembalikan");
