...
//----------------------------------
    ...
    public Resident getResident(String name) {
        ...
        return (Resident) residentTable.get(name);
    }
    ...
    public String getResidentList( ) {
        ...
        Iterator itr = residentTable.values().iterator();
    ...
    public void openFile(String filename)
        ...
        try {
            residentTable = (Map) inObjectStream.readObject();
